...
<html lang="en">
	<head>
		...
		<meta name="author" content="Subharambha Devkota" />
		<meta name="description" content="The lego web page">
		<link rel="shortcut icon" href="images/favicon.png" type="image/x-icon" />
		<link rel="stylesheet" href="css/styles.css" />
	</head>
	<body>
		<img src="images/html-logo.svg" alt="HTML Logo" height="70" width="70">
		<header>
...
<!-- STEP 4: Surround the IMG element below with a pair of FIGURE tags -->
				<img src="images/mini-figure.png" alt="Mini figure" height="160" width="100">
				<p> figcaption try?</p>
